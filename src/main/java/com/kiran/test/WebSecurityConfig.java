...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
	...
	public WebSSOProfileConsumer webSSOprofileConsumer() {
		...
		// Added due to SP and IDP system time mismatches
		webSSOProfileConsumer.setResponseSkew(300);
	...
	public SingleLogoutProfile logoutprofile() {
		...
		// Added due to SP and IDP system time mismatches
		singleLogoutProfileImpl.setResponseSkew(300);
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/").permitAll().antMatchers("/saml/**").permitAll().antMatchers("/css/**")
				...
				.authenticated();
		http.logout().disable();
		// The logout procedure is already handled by SAML filters.
	}
	...
	public ExtendedMetadataDelegate ssoCircleExtendedMetadataProvider() throws MetadataProviderException {
		//To receive IDP metadata directly from site
		...
		try {
			metadata = new ClasspathResource("/metadata/idp.xml");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public ExtendedMetadata extendedMetadata() {
		...
		// below line commented so that the generated SP metadata can able to add in SSO
		// circle
	...
	public MetadataGenerator metadataGenerator() {
		...
		//Entity id used for IDP federation.
		metadataGenerator.setEntityId("com:kiran:test:sp");
